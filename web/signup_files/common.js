...
function validateANSpecial(obj) {
		var objRegExp  =  /^[a-zA-Z0-9-\s\"\#\&\,]+$/; 
		 var flag = objRegExp.test(obj.value);
...
function showTestimonial()
 ...
 if (document.getElementById('PopupMasterContainer').style.display == 'none')
	 {
		document.getElementById('PopupMasterContainer').style.display = 'block' 
	 }
	else if (document.getElementById('PopupMasterContainer').style.display == 'block')
	 {
		document.getElementById('PopupMasterContainer').style.display = 'none' 
	 } 
 }
	...
	xLen = x.length;
		...
		{		 
		 var randomnumber=Math.floor(Math.random()* parseInt(xLen)); 		
		  ...
		  var xx = x[randomnumber].getElementsByTagName("contentbrief");
		  var xy = x[randomnumber].getElementsByTagName("writer");
		  var xxValue = xx[0].firstChild.nodeValue;
		  var xyValue = xy[0].firstChild.nodeValue;
		// document.getElementById('PopupContent').innerHTML = xxValue;
		document.getElementById('itsTestimony').innerHTML = xxValue;
		document.getElementById('itsCustomer').innerHTML = xyValue;
		//alert(xx[0].childNodes[1].childNodes[0].nodeValue);
...
//Check for single quote in the address fields
