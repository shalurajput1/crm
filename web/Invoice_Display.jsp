...
<div id="innerMain" style="padding-bottom: 10px;">
	<div id="sBc"><span class="breadCrumb"> <span class="brdcrmTxtAct">Main Quota Information</span></span></div>
...
<table align="center" ><tr><th><h1 class="tabbgD">&nbsp;&nbsp;&nbsp; Model    Details &nbsp;&nbsp;&nbsp;&nbsp;   </h1> </th></tr> </table>
  ...
  <tr>
    ...
    <th width="88"><h1 class="mycarTophd">Status</h1></th>
    <th width="88"><h1 class="mycarTophd">Invoice Date</h1></th>
    <th width="65"><h1 class="mycarTophd">Amount</h1></th>
    <th width="65"><h1 class="mycarTophd">Margin</h1></th>
                ...
                <tr>
                    ...
                    %>
                         ...
                         <td align="center"><%=i.next()%></td>
                          ...
                          <td><%if(sd.equals("instock")){;%><a href="QuotaAssign.jsp?id2=<%=name%>"><font color="maroon">Assign</font></a><%}%></td></tr>
          <%}}catch(Exception e)
                  {
                     out.println(e);
                   }
