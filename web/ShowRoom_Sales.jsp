<%-- 
    Document   : ShowRoom_Sales
    Created on : Apr 17, 2011, 4:38:35 AM
    Author     : Rohit Pachouli
--%>

<%--
    Document   : Sales_Detail
    Created on : Apr 16, 2011, 6:56:44 AM
    Author     : Rohit Pachouli
--%>
...
<div id="innerMain" style="padding-bottom: 10px;">
	...
	<div id="mainCol" class="bgcolorA">
		<div id="loginTop">
			...
			<h1 class="mycarTophd">Sales Report </h1>
			<div class="mycarList">
				<div class="mycarLstTxt">To check the sales report  </div>
				<div class="mycarLstTxt">Enter the date and fill form carefully</div>
				<div class="mycarLstTxt">To get the reporton date wise </div>
			</div>
		...
		<form name="loginForm" action="Analysis_ShowRoom.jsp" method="post">
		...
		<div class="myProRqFld" style="padding-right: 11px;"><span style="color: red;">* </span>Mandatory fields</div>
			...
			<div class="signRow">
				...
				<div class="signFldC">
                                    <div>	<input name="fdate" id="fdate" readonly Onfocus="displayCalendar(this,'yyyy-mm-dd',this)" maxlength="50" tabindex="16" style="padding: 1px 0pt; width: 175px;" type="text">
                                </div></div><div class="ldReqStar">*</div>
			</div>
                        <div class="signRow">
				<div class="signLbl">Upto</div>
				<div class="signFldC">
                                    <div>	<input name="sdate" readonly id="sdate" Onfocus="displayCalendar(this,'yyyy-mm-dd',this)" maxlength="50" tabindex="16" style="padding: 1px 0pt; width: 175px;" type="text">
                                </div></div><div class="ldReqStar">*</div>
			</div>
