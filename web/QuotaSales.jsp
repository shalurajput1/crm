<%--
    ...
    Created on : Apr 5, 2011, 11:42:03 AM
...
<jsp:useBean id="d" class="crm.QuotaAssign"/>
...
<div id="innerMain" style="padding-bottom: 10px;">
	<div id="sBc"><span class="breadCrumb"> <span class="brdcrmTxtAct">Inventory Information</span></span></div>
	<div id="mainCol" class="bgcolorA">
		<div id="loginTop">
			...
			<div class="mycarBothd">Just get Started Now!</div>
                ...
                <%
        ArrayList ar=d.selectTransfer(k);
        Iterator i=ar.iterator();
        %>
         <form>
                <div align="center">
<table align="center" ><tr><th><h1 class="tabbgD">&nbsp;&nbsp;&nbsp; Model    Details &nbsp;&nbsp;&nbsp;&nbsp;   </h1> </th></tr> </table>
           <table align="center" border="1" bgcolor="#CAF7C8">
  <tr>
     
    <th width="80" height="30"><h1 class="mycarTophd">Invoice No.</h1></th>
    <th width="80"><h1 class="mycarTophd">Engine No.</h1></th>
    <th width="80"><h1 class="mycarTophd">Chachis No.</h1></th>
    <th width="70"><h1 class="mycarTophd">model</h1></th>
    <th width="75"><h1 class="mycarTophd">Varient</h1></th>
    <th width="65"><h1 class="mycarTophd">Color</h1></th>
    <th width="65"><h1 class="mycarTophd">Assign</h1></th>
             ...
             <%try{
               ...
               %>
                ...
                <tr> <td align="center"><%=name%></td>
                    ...
                    try
                      {
                        String vm=(String)i.next();
                       PreparedStatement pn=con.prepareStatement("Select * from colors where cid='"+vm+"'");
                       ResultSet rsn=pn.executeQuery();
                          if(rsn.next())
                                      {
                                      String state=rsn.getString(2);%>
                    ...
                    %>
                         ...
                         <td><%if(er.equals("instock")){;%><a href="QuotaStateAssign.jsp?na=<%=name%>"><font color="maroon">Transfer</font></a><%}%></td>
                         <td><%if(er.equals("instock")){;%><a href="Bill.jsp?na=<%=name%>"><font color="maroon">Sale</font></a><%}%></td>
                          <%}}catch(Exception e)
                  {
                     out.println(e);
                   }
