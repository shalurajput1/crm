	...
	<div id="mainCol" class="bgcolorA">
		<div id="loginTop">
			...
			<div class="mycarBothd">Just get Started Now!</div>
               ...
               <form>
                <div align="center">
<table align="center" ><tr><th><h1 class="tabbgD">&nbsp;&nbsp;&nbsp; Recieving Report &nbsp;&nbsp;&nbsp;&nbsp;   </h1> </th></tr> </table>
  ...
  <tr>
    ...
    <th width="88" height="30"><h1 class="mycarTophd">Transfer from</h1></th>
     <th width="68" height="30"><h1 class="mycarTophd">RDate</h1></th>

  </tr>
   <%try{
        ArrayList ar=d.selectRecieveQuota(k);
        Iterator i=ar.iterator();
         while(i.hasNext())
          {
   ...
   %>
     ...
     <%String io=(String)i.next();
       String io1=(String)i.next();
     %>
     <td align="center"><%=i.next()%></td>
     <td align="center"><%=i.next()%></td>
                          </tr>
