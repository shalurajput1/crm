...
<div id="innerMain" style="padding-bottom: 10px;">
	<div id="sBc"><span class="breadCrumb"> <span class="brdcrmTxtAct">Manage Quota</span></span></div>
	<div id="mainCol" class="bgcolorA">
		...
		<form name="loginForm" action="QuotaAssign1.jsp" method="post">
		...
		<div class="myProRqFld" style="padding-right: 57px;"><span style="color: red;">* </span>Mandatory fields</div>
			<div class="loginInner" style="padding-top: 4px;">
			<div class="logErrMsg">&nbsp;</div>
                        <%
                        String op=request.getParameter("id2");
          ...
          while(iq.hasNext())
           ...
           <option value="<%=m%>"><%=m%></option>
			...
			<div class="loginBtnbox">
				<div class="loginBtn">
                                    <input value="» Assign Quota" alt="Manage  Varient Model" title="Manage Sub Model" class="submitBtn" onmouseover="this.className='submitBtnA'" onmouseout="this.className='submitBtn'" onclick="return validateLogin();"  tabindex="3" style="width: 180px;" type="submit">
