...
<%@page import="myconnection.Connect,java.sql.*,crm.State,java.util.*,crm.SalexUpdate"%>
<jsp:useBean id="dd" class="crm.State"/>
<jsp:setProperty name="dd" property="*"/>
<jsp:useBean id="d" class="crm.SalexUpdate"/>
...
<html>
    ...
    <body>
        <form name="frmsignup" action="SalexUpdate1.jsp" method="post">
            <div id="outerbody">
                <div id="innerbody">
                    <!-- header -->
                    <div id="header">
          ...
          %>
			...
			<div class="signRow">
				...
				<div class="signFldC">
				 <input name="cat"  id="cat" value="<%=i1.next()%>" readonly maxlength="50" tabindex="1" style="padding: 1px 0pt; width: 175px;" type="text">

                                <% String n2=(String)i1.next();%> <% String n3=(String)i1.next();%>
                                  <% String n4=(String)i1.next();%>       
				</div><div class="ldReqStar">*</div>
                               </div> 
			</div>
			...
			<div class="signRow">
				...
				<div class="signFldC">
					<input name="fname" id="fname" maxlength="40" onKeyPress="return validateAlphabet(this)" tabindex="5" style="padding: 1px 0pt; width: 175px;" type="text"value="<%=i1.next()%>" >
                                </div><div class="ldReqStar">*</div>
			</div>
			<div class="signRow">
				<div class="signLbl">Last Name</div>
				<div class="signFldC">
					<input name="lname" id="lname" maxlength="40" onKeyPress="return validateAlphabet(this)" tabindex="6" style="padding: 1px 0pt; width: 175px;" type="text" value="<%=i1.next()%>"  >
				</div>
			</div>
			<div class="signRow">
       ...
       %>
           <option value="<%=o%>"><%=k%></option>
            ...
            %> <% String n5=(String)i1.next();%>
				...
				</div><div class="ldReqStar">*</div></div>
			...
			<div class="signRow">
				...
				<div class="signFldC">
				<div>	<input name="doj" id="doj" Onfocus="displayCalendar(this,'yyyy-mm-dd',this)" maxlength="50" tabindex="16" style="padding: 1px 0pt; width: 175px;" type="text" value="<%=i1.next()%>" >
...
<div></div>
			<div style="width: 265px;">
				...
				<div style="float: left;"><!-- <input type="reset" value="" alt="Reset" title="Reset" class="resetButn" onmouseover="this.className='resetButnA'" onmouseout="this.className='resetButn'" onclick="document.getElementById('txtemail').focus();" tabindex="20" /> --></div>
                                <div style="float: right;"><input value="<< Update!" class="submitBtn" onMouseOver="this.className='submitBtnA'" onMouseOut="this.className='submitBtn'" tabindex="18" style="width: 130px;" type="submit" ></div>
				</div>
