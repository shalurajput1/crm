<%-- 
    Document   : Admin_Quota
    Created on : Apr 16, 2011, 5:09:34 AM
...
<jsp:useBean id="dd" class="crm.model_req"/>
...
<div id="innerMain" style="padding-bottom: 10px;">
	<div id="sBc"><span class="breadCrumb"> <span class="brdcrmTxtAct">ShowRoom Inquiry</span></span></div>
	<div id="mainCol" class="bgcolorA">
		<div id="loginTop">
			...
			<div class="mycarBothd">Just get Started Now!</div>
                ...
                <%
        ArrayList ar=dd.selectInquiry();
        Iterator i=ar.iterator();
        %><form action="Home.jsp">
                <div align="center">
<table align="center" ><tr><th><h1 class="tabbgD">&nbsp;&nbsp;&nbsp; Inquiry Details &nbsp;&nbsp;&nbsp;&nbsp;   </h1> </th></tr> </table>
           <table align="center" border="1" bgcolor="#CAF7C8">
  <tr>
    <th width="80" height="30"><h1 class="mycarTophd">ShowRoom</h1></th>
    <th width="70"><h1 class="mycarTophd">Model</h1></th>
    <th width="75"><h1 class="mycarTophd">Varient</h1></th>
    <th width="75"><h1 class="mycarTophd">Color</h1></th>
    <th width="65"><h1 class="mycarTophd">Quantity</h1></th>
             ...
             <%try{
               ...
               %>
                <tr>
                     ...
                     String col1=(String)i.next();
                     try
                      {
                       PreparedStatement pn=con.prepareStatement("Select * from state where sid='"+name+"'");
                    ...
                    try
                      {
                       PreparedStatement pn=con.prepareStatement("Select * from colors where cid='"+col1+"'");
                       ResultSet rsn=pn.executeQuery();
                          if(rsn.next())
                                      {
                                      String state=rsn.getString(2);%>
