<%-- 
    Document   : Asales_State_Detail
    Created on : Apr 16, 2011, 10:25:00 AM
...
<div id="innerMain" style="padding-bottom: 10px;">
	...
	<div id="mainCol" class="bgcolorA">
		...
		<form name="loginForm" action="Analysis_State_Report.jsp" method="post">
		...
		<div class="myProRqFld" style="padding-right: 11px;"><span style="color: red;">* </span>Mandatory fields</div>
			...
			<h2 class="tabbgB">Sales Report</h2>
				...
				<div class="signFldC">
                    ...
                    <option selected="selected" value="0">SELECT SHOWROOM</option>
                                            <%
try{
