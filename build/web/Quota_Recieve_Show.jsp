	...
	<div id="mainCol" class="bgcolorA">
		<div id="loginTop">
			...
			<div class="mycarBothd">Just get Started Now!</div>
               ...
               <form>
                <div align="center">
<table align="center" ><tr><th><h1 class="tabbgD">&nbsp;&nbsp;&nbsp;Recieve Report &nbsp;&nbsp;&nbsp;&nbsp;   </h1> </th></tr> </table>
           <table align="center" border="1" bgcolor="#CAF7C8">
  <tr>
     <th width="88" height="30"><h1 class="mycarTophd">Invoice</h1></th>
    <th width="88"><h1 class="mycarTophd">Chachis</h1></th>
    <th width="88"><h1 class="mycarTophd">Engine</h1></th>
     <th width="88"><h1 class="mycarTophd">Model</h1></th>
    <th width="88"><h1 class="mycarTophd">Varient</h1></th>
    <th width="88"><h1 class="mycarTophd">Color</h1></th>
    
    <th width="88" height="30"><h1 class="mycarTophd">Recieve</h1></th>
     <th width="88" height="30"><h1 class="mycarTophd">RDate</h1></th>

  </tr>
   <%try{
        ArrayList ar=d.selectRecieve(k);out.println(ar);
        Iterator i=ar.iterator();
         while(i.hasNext())
          {
