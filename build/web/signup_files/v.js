...
function validateLogin()
{
	...
	var logPword = document.getElementById("pass");
...
function chkeditprofile(){
	...
	document.getElementById('add').value = trim(document.getElementById('add1').value);
	document.getElementById('city').value = trim(document.getElementById('city').value);
	document.getElementById('pin').value = trim(document.getElementById('pin').value);
	...
	document.getElementById('add').value = (document.getElementById('add').value).ucfirst();
	...
	if(document.getElementById('pin').value <100000){ 
	...
	document.getElementById('phone1').value = trim(document.getElementById('phone1').value);
	document.getElementById('mobile').value = trim(document.getElementById('mobile').value);

	var phoneLengthHome = document.getElementById('phone').value.length + document.getElementById('phone1').value.length;
	if(phoneLengthHome != 0){
		var stdHomeCodeFtmt = (document.getElementById('phone1').value).substring(0,1);
		var stdHomeCodeFtmt1 = (document.getElementById('phone1').value).substring(1,2);
