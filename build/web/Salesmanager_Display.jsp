...
<div id="innerMain" style="padding-bottom: 10px;">
	<div id="sBc"><span class="breadCrumb"> <span class="brdcrmTxtAct">Manage Staff</span></span></div>
	<div id="mainCol" class="bgcolorA">
        ...
        %><form action="SalexDelete.jsp">
                <div align="center">
                    <table align="center" ><tr><th><h1 class="tabbgD">&nbsp;&nbsp;&nbsp; SalesManager    Details &nbsp;&nbsp;&nbsp;&nbsp;   </h1> </th></tr> </table>
           <table align="center" border="1" bgcolor="#CAF7C8">
  <tr>
      <th width="20"  height="30"><h1 class="mycarTophd">Delete</h1></th>   
    <th width="60" height="30"><h1 class="mycarTophd">ID</h1></th>
    ...
    <th width="79"><h1 class="mycarTophd">Mobile</h1></th>
    <th width="98"><h1 class="mycarTophd">E-Mail</h1></th>
    <th width="82"><h1 class="mycarTophd">Date Of Birth</h1></th>
    <th width="80"><h1 class="mycarTophd">Date Of Join</h1></th>
    <th width="65"><h1 class="mycarTophd">Territory</h1></th>
  </tr>
             <%
                while(i.hasNext())
                    {
                      ...
                      <% String s3=(String)i.next();%>
                       ...
                       <%String ppp=(String)i.next();
                          ...
                          try
                              ...
                              PreparedStatement ps=con.prepareStatement("Select * from state where sid='"+ppp+"'");
                         ...
                         <% int s4=(Integer)i.next();
                          ...
                          try
                              ...
                              PreparedStatement ps=con.prepareStatement("Select * from state where sid='"+pp+"'");
                          ...
                          <td><a href="SalexUpdate.jsp?na=<%=name%>"><font color="maroon">update</font></a></td></tr>
