...
if(xmlHttp==null)
    {
    ...
    else
        {
            ...
            xmlHttp.open("post","SalexAjax.jsp?id10="+value);
            xmlHttp.send(null);
        }
...
<body>
<form name="frm" action="Customer1.jsp" method="post">
<div id="outerbody">
<div id="innerbody">
<!-- header -->
<div id="header">
	...
	<div id="mainCol" class="bgcolorA">
		...
		<div class="myProRqFld" style="padding-right: 11px;"><span style="color: red; font-weight: bold;">&nbsp;</span><span style="color: red;">* </span>Mandatory fields</div>
			...
			<div class="signRow">
				...
				<div class="signFldA">
					<select name="title" id="select" tabindex="2">
			...
			<div class="signRow">
				...
				<div class="signFldC">
					<input name="name" id="name" maxlength="40" onKeyPress="return validateAlphabet(this)" tabindex="3" style="padding: 1px 0pt; width: 175px;" type="text">
				</div><div class="ldReqStar">*</div>
			</div>
			<div class="signRow">
				<div class="signLbl">Address</div>
				<div class="signFldC">
					<input name="add" id="add" maxlength="80" tabindex="4" style="padding: 1px 0pt; width: 175px;" type="text">
				</div><div class="ldReqStar">*</div>
			</div>
                        <div class="signRow">
				<div class="signLbl">City</div>
				<div class="signFldC">
					<input name="city"  id="city" maxlength="30" onKeyPress="return validateAlphabet(this)" tabindex="5" style="padding: 1px 0pt; width: 175px;" type="text">
				</div><div class="ldReqStar">*</div>
			</div>
			<div class="signRow">
				<div class="signLbl">State</div>
				<div class="signFldC">
					<select name="state" id="state" maxlength="80" tabindex="6" style="padding: 1px 0pt; width: 175px;">
       ...
       %>
           <option value="<%=o%>"><%=k%></option>
			...
			<div class="signRow">
				...
				<div class="signFldC">
					<input name="pin" id="pin" maxlength="6" onKeyUp="validateNumeric(this)" tabindex="7" style="padding: 1px 0pt; width: 175px;" type="text">
				</div>
			</div>
			</div>
			<div class="signBox bgNone">
			...
			<div class="signRow">
				...
				<div style="float: left; width: 56px;">
				  <input name="phone" id="phone" maxlength="5" onKeyUp="validateNumeric(this)" tabindex="8" style="padding: 1px 0pt; width: 50px;" type="text"></div>
				<div style="float: left; width: 118px; padding-left: 5px;">
				  <input name="phone1" id="phone1" maxlength="10" onKeyUp="validateNumeric(this)" tabindex="9" style="padding: 1px 0pt; width: 110px;" type="text">
				</div>
			</div>
			...
			<div class="signRow">
				...
				<div style="float: left; width: 118px; padding-left: 5px;">
				  <input name="mobile" id="mobile" maxlength="10" onKeyUp="validateNumeric(this)" tabindex="10" style="padding: 1px 0pt; width: 110px;" type="text">
				</div><div class="ldReqStar">*</div>
			</div>
			<div class="signRow">
				<div class="signLbl">E-mail ID</div>
				<div class="signFldC">
					<input name="email" id="email" maxlength="50" tabindex="11" style="padding: 1px 0pt; width: 175px;" type="text">
				</div><div class="ldReqStar">*</div>
			</div>
			<div class="signRow">
				<div class="signLbl">DOB</div>
				<div class="signFldC">
                                    <div><input name="dob" readonly id="dob" Onfocus="displayCalendar(this,'yyyy-mm-dd',this)" maxlength="50" tabindex="12" style="padding: 1px 0pt; width: 175px;" type="text"></div>
				</div><div class="ldReqStar">*</div>
			</div>
			<div class="signRow">
				<div class="signLbl">Income Group</div>
				<div class="signFldC">
				<div>	<input name="ig" id="ig" maxlength="6" onKeyUp="validateNumeric(this)" tabindex="13" style="padding: 1px 0pt; width: 175px;" type="text">
                                </div></div><div class="ldReqStar">*</div>
			</div>
			<div class="signRow">
				<div class="signLbl">Occuption</div>
				<div class="signFldC">
					<input name="occu" id="occu" onKeyPress="return validateAlphabet(this)" maxlength="50" tabindex="14" style="padding: 1px 0pt; width: 175px;" type="text">
				</div><div class="ldReqStar">*</div>
			</div>
			...
			<div style="width: 265px;">
				...
				<div style="float: left;"><!-- <input type="reset" value="" alt="Reset" title="Reset" class="resetButn" onmouseover="this.className='resetButnA'" onmouseout="this.className='resetButn'" onclick="document.getElementById('txtemail').focus();" tabindex="20" /> --></div>
                                <div style="float: right;"><input value="<< Submit!" class="submitBtn" onMouseOver="this.className='submitBtnA'" onMouseOut="this.className='submitBtn'" tabindex="15" style="width: 130px;" type="button" onclick="customer();"></div>
				</div>
				</div>
		</div>
	</div>
